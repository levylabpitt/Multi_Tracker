...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    //    barcodeView.setDecoderFactory(new DefaultDecoderFactory(decodeFormats, decodeHints, characterSet, scanType));
        Collection<BarcodeFormat> formats = Arrays.asList(BarcodeFormat.QR_CODE); // for QR scanning only
        barcodeView.setDecoderFactory(new DefaultDecoderFactory(formats, decodeHints, characterSet, scanType));
    }
