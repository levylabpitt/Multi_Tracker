...
public class DriveOperationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drive_operation);
        initView();
        ...
        uploadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String filePath = "/storage/0403-0201/picture/storage/Pictures/International-windwill_&_75c074b5-e745-45f8-9b3c-c910b7ae6598.jpg";
                String fileExt = "";
                ...
                mDriveServiceHelper.uploadFile(file, mime_type, "1U_T-UOA3s-6vACPdMM4oAD6S1ijpkiby")
                        .addOnSuccessListener(new OnSuccessListener<GoogleDriveFileHolder>() {
                            @Override
                            public void onSuccess(GoogleDriveFileHolder googleDriveFileHolder) {
                                Gson gson = new Gson();
...
*/
        downloadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDriveServiceHelper.downloadFile(new File(getApplicationContext().getFilesDir(), "filename.txt"), "google_drive_file_id_here")
