...
import com.pqiorg.multitracker.feasybeacon.Widget.AboutUsDialog;
import com.pqiorg.multitracker.feasybeacon.Widget.QRDialog;
...
public class AboutActivityFeasyBeacon extends BaseActivity {
    @BindView(R.id.more)
    TextView more;
    @BindView(R.id.qr)
    LinearLayout qr;
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, AboutActivityFeasyBeacon.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_beacon);
        activity = this;
